    ...
    switch (this.state.currentPage) {
      ...
      case "password":
        ...
        if (
          ...
          this.setState({
            currentMessage: t("SignUp.Errors.PasswordInvalidCondition")
          });
          return;
        }
  ...
  register() {
    APIClient.POST(
      ...
      data => {
        ...
        else this.setState({ currentMessage: "Failed to register account!" });
      }
    );
  }
          ...
          <Row>
            {this.state.currentPage === "email" && (
              <AuthCard>
                ...
                />
                <Button onClick={() => this.switchPage("password")}>
                  {t("SignUp.SubmitMail")}
                </Button>
              </AuthCard>
            )}
            ...
            {this.state.currentPage === "password" && (
              <AuthCard>
                ...
                <Input
                  ...
                  onChange={e => this.onChange(e.target.value)}
                />
                <Button onClick={() => this.switchPage("agreement")}>
                  {t("SignUp.SubmitPass")}
                </Button>
              </AuthCard>
            )}
            ...
            {this.state.currentPage === "success" && (
              <AuthCard>
                ...
                <Button onClick={() => this.register()}>
                  <Link to="/">{t("SignUp.SubmitSuccess")}</Link>
                </Button>
              </AuthCard>
            )}
          </Row>
