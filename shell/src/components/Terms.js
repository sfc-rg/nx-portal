...
class TermDoc extends React.Component {
  render() {
    const { t } = this.props;
    ...
    return (
      <>
        <div className="wrapHINAGATA">
          ...
          <p>
            <strong>{t("LanguageWarning")}</strong>
          </p>
          ...
          <ol>
            <li>
              ...
              <ol>
                ...
                <li>
                  地震，落雷，火災，停電または天災、感染症などの不可抗力により，本サービスの提供が困難となった場合
                </li>
          ...
          <p>
            ユーザーは，以下の条件に同意の上,
            運営の定める退会手続により，本サービスから退会できるものとします。
          </p>
          <ol>
            <li>Wallet内の残高の返金は致しません.</li>
            <li>
              予約が残っている場合は,
              最後の予約が完了するまで退会手続きが完了致しません.
              予約を全てキャンセルした上で
            </li>
          </ol>
...
export default withTranslation("license")(TermDoc);
